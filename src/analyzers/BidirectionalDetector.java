...
public class BidirectionalDetector extends AbstractAnalyzer{
		...
		for (IClassEdge e1 : fromAtoB) {
			for (IClassEdge e2 : fromBtoA) {
				...
				if (e1 instanceof AssociationEdge && e2 instanceof AssociationEdge) {
					mergerAndColor (e1.getCorrespondingDOMNode(), e2.getCorrespondingDOMNode());
	...
	public void mergerAndColor(IDOMEdgeNode e1, IDOMEdgeNode e2) {
